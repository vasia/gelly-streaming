 ...
 * in the {@link GraphWindowStream#reduceOnNeighbors(Object, EdgesFold)} method.
 *
...
public interface EdgesFold<K, EV, T> extends Function, Serializable {
	 ...
	 * The reduceEdges function is consecutively applied to all edges of a neighborhood,
	 ...
	 * @throws Exception
	 */
	T reduceEdges(T accum, K vertexID, K neighborID, EV edgeValue) throws Exception;
}
